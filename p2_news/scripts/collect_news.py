"""Pipeline 2 — news / journalism accounts daily collection (server only).

Usage:
    python scripts/collect_news.py --date YYYY-MM-DD --sample
    python scripts/collect_news.py --date YYYY-MM-DD
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Pipeline 2: news collection + CSV archive"
    )
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Use sample_handle_group (news_sample)",
    )
