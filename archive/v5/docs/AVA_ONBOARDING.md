...
| Daily production job (v5.0) | `python scripts/enrich_pipeline.py --production --group <group>` |
| Daily P1 / P2 / P3 collection | See [`COLLECTION_PIPELINES.md`](COLLECTION_PIPELINES.md) — *How to run P1 / P2 / P3 from your laptop* |
