...
from enrichment.frames_smart import encode_frame_jpeg, sample_keyframes
from enrichment.ocr_postprocess import clean_ocr_text, primary_source_type
...
def _get_vision_client():
    ...
    from enrichment.bigquery_loader import vision_enabled
...
def ocr_video_file(
    ...
    *,
    ...
    """
    from enrichment.ocr_postprocess import dedupe_ocr_frames
